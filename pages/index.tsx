  ...
  return (
    <Layout>
      <div className="justify-center text-center">
        <h1 className="text-4xl font-bold mt-16">Humber Sanchez</h1>
        <h2 className="text-lg font-normal mt-4 text-neutral-900 dark:text-neutral-300">
          Ingeniero de Sistemas
        </h2>
        <p className="max-w-md text-neutral-900 dark:text-neutral-300 mx-auto mt-6">
          Apasionado por la tecnología con más de 3 años de experiencia
          encargado de desarrollar e implementar soluciones tecnológicas en
